 ...
 * [решено] см. https://github.com/VPROFi/sqlplugin SQLite - очень часто нужно при разработке залезть в SQLite db в фаре и что-нибудь быстро просмотреть - плагин SQLite DB Browser не работает в far2l
